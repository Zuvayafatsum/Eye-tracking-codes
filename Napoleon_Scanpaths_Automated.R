...
# ==============================================================================
fixations_raw <- read_csv("/Users/mustafacvbe/Downloads/img_data 2/Napoleon_1/fixations.csv", show_col_types = FALSE)
...
target_image_raw <- image_read("/Users/mustafacvbe/Downloads/img_data 2/Napoleon_1/reference_image.jpeg")
...
ggsave(
  filename = "automated_scanpaths_with_background_Napoleon.png", 
